...
void _taskModelSerialize(
  ...
  writer.writeLong(offsets[0], object.anxietyLevel);
...
TaskModel _taskModelDeserialize(
  ...
  final object = TaskModel(
    anxietyLevel: reader.readLong(offsets[0]),
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> anxietyLevelEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'anxietyLevel',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> anxietyLevelBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByAnxietyLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'anxietyLevel', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByAnxietyLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'anxietyLevel', Sort.desc);
    });
  }
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByAnxietyLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'anxietyLevel', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByAnxietyLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'anxietyLevel', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByAnxietyLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'anxietyLevel');
    });
  }
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, int, QQueryOperations> anxietyLevelProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'anxietyLevel');
    });
  }
